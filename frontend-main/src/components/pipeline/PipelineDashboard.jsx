...
const PipelineDashboard = () => {
  ...
  // socket subscription. server doesn't actually emit "pipelineUpdate"
  // anywhere yet -- the listener is here so the wiring is in place when
  // the backend job-runner starts emitting. for now the trigger button
  // calls fetchPipelines() directly.
  useEffect(() => {
