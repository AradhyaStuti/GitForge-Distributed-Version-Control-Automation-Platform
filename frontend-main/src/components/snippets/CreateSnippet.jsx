...
const CreateSnippet = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // sometimes the create response shape changes between server versions,
      // so guard the navigate. fallback to /snippets list if no id.
      if (res.data?._id) navigate(`/snippet/${res.data._id}`);
