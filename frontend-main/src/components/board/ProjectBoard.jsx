...
const ProjectBoard = () => {
  ...
  const handleCardMove = async (targetColumnIndex) => {
    ...
    // optimistic move. rollback on failure but the toast message races the
    // re-render, so the user briefly sees the card snap back THEN the toast
    // appears. annoying but acceptable.
