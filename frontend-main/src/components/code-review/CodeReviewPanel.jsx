...
// "AI" in the UI is pattern matching against a list of unsafe patterns
// + complexity heuristics on the server. not actually ML. naming kept for
// the panel because users find it more legible than "static analysis".
