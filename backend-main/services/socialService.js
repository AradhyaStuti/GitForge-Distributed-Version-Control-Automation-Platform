...
class SocialService {
  ...
  async forkRepo(userId, repoId) {
    ...
    // shallow content copy. for big repos this is going to be slow and
    // wasteful since we're duplicating every blob -- a proper impl would
    // share storage and only copy on write. revisit when it matters.
