...
// Quick deny-list. Not a substitute for a real sandbox -- if this ever
// runs untrusted input we need to wrap each step in docker or firejail.
// TODO: container-per-step
...
class PipelineService {
  ...
  async triggerRun(pipelineId, userId, { branch, commitSha } = {}) {
    ...
    // fire-and-forget. would be nicer with a job queue but mongo is fine for now
  ...
  async getBadge(pipelineId) {
    ...
    // shields.io style colors. ugly but readable on README pages
