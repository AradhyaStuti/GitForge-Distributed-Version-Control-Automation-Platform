...
const options = {
  ...
  // schemas only -- per-endpoint JSDoc annotations aren't maintained on the
  // routers, so we expose this as a schema browser rather than promising
  // autogenerated endpoint coverage.
  apis: [],
};
