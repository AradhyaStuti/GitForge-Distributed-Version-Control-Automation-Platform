...
async function commitRepo(message) {
  ...
  try {
    ...
    // copy each staged file into the commit dir. real git would hash and
    // dedupe by content -- this duplicates blobs across commits which is
    // wasteful but keeps the on-disk format readable for debugging.
