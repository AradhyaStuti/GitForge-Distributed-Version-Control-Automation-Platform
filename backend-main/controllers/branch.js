...
// "merge" = stage the source branch's tip files into current. no actual
// 3-way merge logic, no conflict detection -- this is the rough edge
// called out in the README. fix when I get around to a proper merge base.
